...
FreqAI 是一款旨在自动化与训练预测性机器学习模型相关的各种任务的软件，该模型可根据一组输入信号生成市场预测。总体而言，FreqAI 旨在成为一个沙盒，便于在实时数据上轻松部署强大的机器学习库（[详情](#freqai-position-in-open-source-machine-learning-landscape)）。
...
测试与 bug 报告：
Stefan Gehring, Longyu, Andrew Lawless, Pascal Schmidt, Ryan McMullan, Juha Nykänen, Johan van der Vlugt, Richárd Józsa
